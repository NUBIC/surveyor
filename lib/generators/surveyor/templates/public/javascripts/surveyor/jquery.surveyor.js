...
jQuery(document).ready(function(){
  ...
  jQuery("form#survey_form input, form#survey_form select, form#survey_form textarea").change(function(){
    ...
    $.blockUI.defaults.message = "<h1>Saving...</h1>";
    $.blockUI();
    ...
    $.ajax({ type: "PUT", url: $(this).parents('form#survey_form').attr("action"), data: question_data, dataType: 'json', success: successfulSave, error: onError })
  });
  // }
