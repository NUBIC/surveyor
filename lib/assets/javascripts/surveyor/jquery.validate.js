...
$.extend($.validator, {
	...
	prototype: {
		...
		form: function() {
      console.log('before checking the form');
      last_question = $(this.currentForm).find("input[type='text']").last();
      $form        = this;
			$currentForm = $(this.currentForm);
      var $result;
      if (last_question.val() != "" && typeof last_question !== "undefined" ){
    ...
    successfulSave: function(responseText) {
      ...
      return false;
        ...
        if ($("label.error:visible").length > 0) {
          $('html, body').animate({
            scrollTop: $("label.error:visible").first().offset().top-30
          }, 500);
        }
			}
		},
