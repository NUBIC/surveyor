class PermittedParams < Struct.new(:params)
  ...
  def survey_attributes
    [:title, :description, :reference_identifier, :data_export_identifier, :common_namespace, :common_identifier, :css_url, :custom_class, :display_order, :redirect_url, :access_code, :acronym, :acronym_expanded, :published_reference]
  end
