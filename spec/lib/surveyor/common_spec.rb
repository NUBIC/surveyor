...
describe Surveyor::Common, "" do
  it "should create a normalized code from the answer text" do
    # Should take the title of the text and convert it to a code that is more appropirate for a database entry

    # Taking a few answers from the survey for testing
    strings = { "This? is a in - t3rrible-@nswer of! (question) on" => "this_t3rrible_nswer",
    ...
    strings.each do |k, v|
      Surveyor::Common.to_normalized_string(k).should == v
    end
